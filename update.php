<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'GET'){
        ...
        $sk_izin_operasional    = $_POST["sk_operasional"];
        $tgl_izin_operasional   = $_POST["tgl_operasional"];
        $alamat                 = $_POST["alamat"];
        $rt                     = $_POST["rt"];
        $rw                     = $_POST["rw"];
        $dusun                  = $_POST["dusun"];
